...
extra/CMakeFiles/my_print_defaults.dir/my_print_defaults.c.o: extra/my_print_defaults.c
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building C object extra/CMakeFiles/my_print_defaults.dir/my_print_defaults.c.o"
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/extra && /usr/bin/cc  $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -o CMakeFiles/my_print_defaults.dir/my_print_defaults.c.o   -c /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/extra/my_print_defaults.c
...
extra/CMakeFiles/my_print_defaults.dir/my_print_defaults.c.i: cmake_force
	...
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/extra && /usr/bin/cc  $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/extra/my_print_defaults.c > CMakeFiles/my_print_defaults.dir/my_print_defaults.c.i
...
extra/CMakeFiles/my_print_defaults.dir/my_print_defaults.c.s: cmake_force
	...
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/extra && /usr/bin/cc  $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/extra/my_print_defaults.c -o CMakeFiles/my_print_defaults.dir/my_print_defaults.c.s
...
extra/my_print_defaults: extra/CMakeFiles/my_print_defaults.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable my_print_defaults"
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/extra && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/my_print_defaults.dir/link.txt --verbose=$(VERBOSE)
...
extra/CMakeFiles/my_print_defaults.dir/clean:
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/extra && $(CMAKE_COMMAND) -P CMakeFiles/my_print_defaults.dir/cmake_clean.cmake
.PHONY : extra/CMakeFiles/my_print_defaults.dir/clean

extra/CMakeFiles/my_print_defaults.dir/depend:
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/extra /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/extra /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/extra/CMakeFiles/my_print_defaults.dir/DependInfo.cmake --color=$(COLOR)
