...
tests/CMakeFiles/mysql_client_test.dir/mysql_client_test.c.o: tests/mysql_client_test.c
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building C object tests/CMakeFiles/mysql_client_test.dir/mysql_client_test.c.o"
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/tests && /usr/bin/cc  $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -o CMakeFiles/mysql_client_test.dir/mysql_client_test.c.o   -c /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/tests/mysql_client_test.c
...
tests/CMakeFiles/mysql_client_test.dir/mysql_client_test.c.i: cmake_force
	...
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/tests && /usr/bin/cc  $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/tests/mysql_client_test.c > CMakeFiles/mysql_client_test.dir/mysql_client_test.c.i
...
tests/CMakeFiles/mysql_client_test.dir/mysql_client_test.c.s: cmake_force
	...
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/tests && /usr/bin/cc  $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/tests/mysql_client_test.c -o CMakeFiles/mysql_client_test.dir/mysql_client_test.c.s
...
tests/mysql_client_test: tests/CMakeFiles/mysql_client_test.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable mysql_client_test"
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/mysql_client_test.dir/link.txt --verbose=$(VERBOSE)
...
tests/CMakeFiles/mysql_client_test.dir/clean:
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/tests && $(CMAKE_COMMAND) -P CMakeFiles/mysql_client_test.dir/cmake_clean.cmake
.PHONY : tests/CMakeFiles/mysql_client_test.dir/clean

tests/CMakeFiles/mysql_client_test.dir/depend:
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/tests /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/tests /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/tests/CMakeFiles/mysql_client_test.dir/DependInfo.cmake --color=$(COLOR)
