...
strings/CMakeFiles/conf_to_src.dir/conf_to_src.c.o: strings/conf_to_src.c
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building C object strings/CMakeFiles/conf_to_src.dir/conf_to_src.c.o"
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/strings && /usr/bin/cc  $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -o CMakeFiles/conf_to_src.dir/conf_to_src.c.o   -c /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/strings/conf_to_src.c
...
strings/CMakeFiles/conf_to_src.dir/conf_to_src.c.i: cmake_force
	...
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/strings && /usr/bin/cc  $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/strings/conf_to_src.c > CMakeFiles/conf_to_src.dir/conf_to_src.c.i
...
strings/CMakeFiles/conf_to_src.dir/conf_to_src.c.s: cmake_force
	...
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/strings && /usr/bin/cc  $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/strings/conf_to_src.c -o CMakeFiles/conf_to_src.dir/conf_to_src.c.s
...
strings/conf_to_src: strings/CMakeFiles/conf_to_src.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking C executable conf_to_src"
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/strings && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/conf_to_src.dir/link.txt --verbose=$(VERBOSE)
...
strings/CMakeFiles/conf_to_src.dir/clean:
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/strings && $(CMAKE_COMMAND) -P CMakeFiles/conf_to_src.dir/cmake_clean.cmake
.PHONY : strings/CMakeFiles/conf_to_src.dir/clean

strings/CMakeFiles/conf_to_src.dir/depend:
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/strings /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/strings /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/strings/CMakeFiles/conf_to_src.dir/DependInfo.cmake --color=$(COLOR)
