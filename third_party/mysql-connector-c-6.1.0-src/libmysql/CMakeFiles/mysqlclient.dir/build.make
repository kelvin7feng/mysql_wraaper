...
libmysql/mysqlclient_depends.c: extra/yassl/taocrypt/libtaocrypt.a
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating mysqlclient_depends.c"
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/libmysql && /usr/local/bin/cmake -E touch /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/libmysql/mysqlclient_depends.c
...
libmysql/CMakeFiles/mysqlclient.dir/mysqlclient_depends.c.o: libmysql/mysqlclient_depends.c
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Building C object libmysql/CMakeFiles/mysqlclient.dir/mysqlclient_depends.c.o"
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/libmysql && /usr/bin/cc  $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -o CMakeFiles/mysqlclient.dir/mysqlclient_depends.c.o   -c /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/libmysql/mysqlclient_depends.c
...
libmysql/CMakeFiles/mysqlclient.dir/mysqlclient_depends.c.i: cmake_force
	...
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/libmysql && /usr/bin/cc  $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/libmysql/mysqlclient_depends.c > CMakeFiles/mysqlclient.dir/mysqlclient_depends.c.i
...
libmysql/CMakeFiles/mysqlclient.dir/mysqlclient_depends.c.s: cmake_force
	...
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/libmysql && /usr/bin/cc  $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/libmysql/mysqlclient_depends.c -o CMakeFiles/mysqlclient.dir/mysqlclient_depends.c.s
...
libmysql/libmysqlclient.a: libmysql/CMakeFiles/mysqlclient.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Linking C static library libmysqlclient.a"
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/libmysql && $(CMAKE_COMMAND) -P CMakeFiles/mysqlclient.dir/cmake_clean_target.cmake
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/libmysql && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/mysqlclient.dir/link.txt --verbose=$(VERBOSE)
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/libmysql && rm /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/libmysql/libmysqlclient.a
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/libmysql && /usr/local/bin/cmake -P /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/libmysql/merge_archives_mysqlclient.cmake
...
libmysql/CMakeFiles/mysqlclient.dir/clean:
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/libmysql && $(CMAKE_COMMAND) -P CMakeFiles/mysqlclient.dir/cmake_clean.cmake
.PHONY : libmysql/CMakeFiles/mysqlclient.dir/clean

libmysql/CMakeFiles/mysqlclient.dir/depend: libmysql/mysqlclient_depends.c
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/libmysql /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/libmysql /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/libmysql/CMakeFiles/mysqlclient.dir/DependInfo.cmake --color=$(COLOR)
