...
libmysql/libmysqlclient_r.so.18: libmysql/libmysqlclient.so
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating libmysqlclient_r.so.18"
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/libmysql && /usr/local/bin/cmake -E remove -f /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/libmysql/libmysqlclient_r.so.18
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/libmysql && /usr/local/bin/cmake -E create_symlink libmysqlclient.so libmysqlclient_r.so.18
...
libmysql/CMakeFiles/symlink_libmysqlclient_r.so.18.dir/clean:
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/libmysql && $(CMAKE_COMMAND) -P CMakeFiles/symlink_libmysqlclient_r.so.18.dir/cmake_clean.cmake
...
libmysql/CMakeFiles/symlink_libmysqlclient_r.so.18.dir/depend:
	cd /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/libmysql /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/libmysql /opt/dev/mysql_wrapper/third_party/mysql-connector-c-6.1.0-src/libmysql/CMakeFiles/symlink_libmysqlclient_r.so.18.dir/DependInfo.cmake --color=$(COLOR)
